  ...
  return (
    <div className="bg-black">
      <StatementSection
        ...
        body="IMOS exists to turn AI from an isolated chat surface into an operator-grade system. It combines gateway routing, authenticated access, sessions, memory, tools, workflows, and messaging into one runtime that can reason and execute with continuity."
      />

      <ContentSection
        eyebrow="Principles"
        title="The product is separated on purpose."
        description="The public frontend explains the product and handles sign-in. The dashboard exposes live state and control. The runtime owns actual execution. That separation keeps the experience clean without hiding operational truth."
      >
      ...
      <StatementSection
        ...
        body="A chat model by itself does not provide deployment, sessions, memory, workflows, or channel delivery. IMOS treats that as one product problem instead of separate implementation chores."
      />
